...
do{\
    ...
    strcpy((OPTION_TO)->comment,(OPTION_FROM)->comment);\
}while(0)
...
#define OPTION_GET_COMMENT(OPTION)\
    (OPTION)->comment
...
#define INCEPTION_BINLOG_FLUSH_TRANSFER    10
